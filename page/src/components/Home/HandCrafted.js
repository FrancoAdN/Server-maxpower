                ...
                <div className="container py-lg-5">
                    <div className="row accord-info">
                        <div className="col-lg-6 pl-md-5">
                            ...
                            <p data-aos="fade-right" data-aos-duration="1500">
                                <span style={{ color: '#fff' }}>Nuestra misión:</span> Ser una empresa líder en el mercado brindando soluciones tecnológicas con valor agregado para nuestros clientes.
                            </p>
                            <p data-aos="fade-right" data-aos-duration="1500">
                                <span style={{ color: '#fff' }}>Nuestra visión:</span> Ser referentes en el mercado nacional e internacional a través de un servicio de asistencia de excelencia y eficiencia que nos permita apoyar el crecimiento y fortalecimiento del sector industrial.
                            </p>
                            <p className="mt-3">
                            </p>
                            <p></p>
